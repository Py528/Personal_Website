...
function About() {
	return (
		<div className="about m-auto px-6 py-12 bg-white">
			<div className="container mx-auto flex flex-col lg:flex-row gap-6 justify-center items-center max-w-[60%] w-[90%]">
				...
				<div className="text-side w-full lg:w-1/2 text-lg">
					<h2 className="text-[#008cff] font-bold text-xl lg:text-2xl mb-4 lg:mb-8">About me</h2>
					<h3 className="text-[#333] font-bold text-2xl lg:text-4xl leading-9 lg:leading-12 mb-8">
						A dedicated Front-end Developer <br /> based in Pune, India 📍
					</h3>
					<p className="text-[#333] leading-6 mb-8">
